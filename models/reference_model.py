...
class AppearanceEncoderModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        self.up_blocks[3].attentions[2].transformer_blocks[0].attn1.to_q = Identity()
        self.up_blocks[3].attentions[2].transformer_blocks[0].attn1.to_k = Identity()
        self.up_blocks[3].attentions[2].transformer_blocks[0].attn1.to_v = Identity()
